...
RSpec.describe "missing asset packs" do
  ...
  it "renders the view" do
    expect(call("/packs/autoload")[2]).to include("autoload")
  end

  it "does not include the stylesheet" do
    expect(call("/packs/autoload")[2]).not_to include("link")
  end

  it "does not include the javascript" do
    expect(call("/packs/autoload")[2]).not_to include("script")
  end
end
...
RSpec.describe "versioned asset packs" do
  ...
  it "includes the latest js pack" do
    expect(call("/assets/packs/versioned.js")[2]).to eq("\"use strict\";\n\nconsole.log(\"2.0\");")
  end

  it "includes the latest css pack" do
    expect(call("/assets/packs/versioned.css")[2]).to eq("body {\n  content: \"2.0\"; }\n")
  end
end
...
RSpec.describe "versioned, namespaced asset packs" do
  ...
  it "includes the latest js pack" do
    expect(call("/assets/packs/bar.js")[2]).to eq("\"use strict\";\n\nconsole.log(\"2.0 bar\");")
  end

  it "includes the latest css pack" do
    expect(call("/assets/packs/bar.css")[2]).to eq("body {\n  content: \"2.0 bar\"; }\n")
  end
end
