RSpec.describe "using specific scope versions inline" do
  ...
  context "object is created in a way that sets version" do
    it "transforms" do
      transformations = save_ui_case("versioned_scope_create_inline", path: "/posts") do
  ...
  context "object is updated in a way that changes its version" do
    it "transforms" do
      ...
      transformations = save_ui_case("versioned_scope_value_change_inline", path: "/posts") do
...
RSpec.describe "using specific scope versions during presentation" do
  include_context "testable app"
  include_context "websocket intercept"
  ...
  context "object is created in a way that sets version" do
    it "transforms" do
      transformations = save_ui_case("versioned_scope_create", path: "/posts") do
        call("/posts", method: :post, params: { post: { title: "foo" } })
      end
  ...
  context "object is updated in a way that changes its version" do
    it "transforms" do
      ...
      transformations = save_ui_case("versioned_scope_value_change", path: "/posts") do
        expect(call("/posts/1", method: :patch, params: { post: { published: true } })[0]).to eq(200)
      end
...
RSpec.describe "using specific scope versions during presentation with a change occuring after" do
  include_context "testable app"
  include_context "websocket intercept"
  ...
  context "object is created in a way that sets version" do
    it "transforms" do
      transformations = save_ui_case("versioned_scope_create_before_attr_set", path: "/posts") do
        call("/posts", method: :post, params: { post: { title: "foo" } })
      end
  ...
  context "object is updated in a way that changes its version" do
    it "transforms" do
      ...
      transformations = save_ui_case("versioned_scope_value_change_before_attr_set", path: "/posts") do
        expect(call("/posts/1", method: :patch, params: { post: { published: true } })[0]).to eq(200)
      end
