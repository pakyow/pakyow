RSpec.describe "reflected graph: nested scope contains a binding endpoint with broader context" do
  include_context "reflectable app"
  include_context "mirror"

  let :frontend_test_case do
    "state/nested_scope_contains_binding_endpoint_with_broader_context"
  end
