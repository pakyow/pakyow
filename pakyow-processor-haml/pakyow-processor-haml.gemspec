...
path = File.exists?('pakyow-processor-haml') ? 'pakyow-processor-haml' : '.'

Gem::Specification.new do |s|
  s.platform    = Gem::Platform::RUBY
  s.name        = 'pakyow-processor-haml'
  s.version     = version
  s.summary     = 'pakyow-processor-haml'
  s.description = 'pakyow-processor-haml'
  s.required_ruby_version = '>= 1.9.3'

  s.authors           = ['Bryan Powell']
  s.email             = 'bryan@metabahn.com'
  s.homepage          = 'http://pakyow.com'
  s.rubyforge_project = 'pakyow-processor-haml'
